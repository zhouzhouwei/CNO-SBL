...
num_method = 7 ;
nums = 100;   snr = 40 ;
filename = ['ResultsData\Spike_',num2str(snr),'dB_n',num2str(n),'_2NN_CM.mat'] ;
...
ylim([-1,1])
grid on
axes('Position',[0.651 0.428 0.139 0.0454]) 
ids = [5:10];
plot(ids,w_est(ids,5),'LineWidth',2)
ylim([-0.01 0.01])
xlim([5,10])
grid on
annotation('textbox',[0.63 0.399 0.288 0.0181],'LineWidth',1)
annotation('textarrow',[0.676 0.683], [0.419 0.437])
