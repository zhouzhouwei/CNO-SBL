...
rng(2)
% load data
load('Dataset\GaussianData1.mat') ;

% experimental setting
[m, n] = size(Phi) ; 
num_method = 7  ;
nums = 100;   snr = 40 ;
filename = ['ResultsData\Gaussian_',num2str(snr),'dB_n',num2str(n),'_2NN_CM.mat'] ;
...
% xlabel('Sequential number of experimental runs')
